...
```ts
import { useCreateUser, useUpdateUser, useDeleteUser, useGetUser, useListUsers, useCreateCourse, useUpdateCourse, useDeleteCourse, useGetCourse, useListCourses } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useCreateCourse();

const { data, isPending, isSuccess, isError, error } = useUpdateCourse();

const { data, isPending, isSuccess, isError, error } = useDeleteCourse();
...
```js
import { createUser, updateUser, deleteUser, getUser, listUsers, createCourse, updateCourse, deleteCourse, getCourse, listCourses } from '@dataconnect/generated';
